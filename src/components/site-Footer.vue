            ...
            <div class="container">
                <div class="footer-inner">
                    <ul class="footer-menu">
                        <li class="footer-menu-item"><a href="#" exact active-class="active">О нас</a></li>
                        <li class="footer-menu-item"><a href="#" active-class="active">Доставка</a></li>
                        <li class="footer-menu-item"><a href="#" active-class="active">Помощь</a></li>
                    </ul>
                    ...
                    <div class="footer-social">
                        <a href="tel:+998911234567" class="footer-social-phone"><span>Телефон:</span>+998 90 123 45
                            76</a>
            ...
            <div class="container">
                <div class="connect-wrap">
                    <div class="connect-item">
                        <p class="connect-text">© Imba</p>
                    </div>
                    <div class="connect-item">
                        <p class="connect-text">2020 - Web developed by <a href="#">SOS Group</a></p>
                    </div>
                </div>
            </div>
        </div>
